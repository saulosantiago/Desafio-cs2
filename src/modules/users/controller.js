 ...
 *     }
 */
module.exports.createUser = async function createUser(ctx) {
  let user;
  let token;
  try {
    await Joi.validate(ctx.request.body.user, SignUp);
    ctx.request.body.user.geolocation = await Geocode.getLocation(ctx.request.body.user.CEP);
 ...
 * @apiUse TokenError
 */
module.exports.getUser = async function getUser(ctx, next) {
  try {
 ...
 * @apiUse TokenError
 */
module.exports.updateUser = async function updateUser(ctx) {
  const { user } = ctx.body;
...
module.exports.deleteUser = async function deleteUser(ctx) {
  const { user } = ctx.body;
